...
public class AiPlanController {
    ...
    private final PlanGenerateV2Service planGenerateV2Service;
    ...
    public Result<Void> updateDayItem(@PathVariable Long planId,
        ...
        if (newItem == null) {
            return Result.error(400, "newItem 不能为空");
        }
    ...
    public Result<Void> replaceDayItems(@PathVariable Long planId,
        ...
        if (items == null) {
            return Result.error(400, "items 不能为空");
        }
    ...
    public Result<Void> updatePlanContent(@PathVariable Long planId,
        ...
        if (plan == null && days == null) {
            return Result.error(400, "plan 和 days 不能同时为空");
        }
