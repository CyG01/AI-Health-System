...
public class ChatController {
    ...
    // Optional dependency: may be null if Redis is not configured
    ...
    private void cacheDelta(String cacheKey, String delta) {
        ...
        try {
            ...
            log.debug("Failed to cache SSE delta to Redis: {}", e.getMessage());
        }
    }
    ...
    private void clearCache(String cacheKey) {
        ...
        try {
            ...
            log.warn("Failed to clear SSE cache from Redis: {}", e.getMessage());
        }
    }
}