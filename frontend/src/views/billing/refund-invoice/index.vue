...
async function loadRefundStatus() {
  ...
  try {
    ...
    refundStatus.value = data as RefundStatus
  } catch { message.error('加载退款状态失败') }
...
async function loadInvoiceList() {
  ...
  try {
    ...
    invoiceList.value = (data as Invoice[]) || []
...
async function viewInvoice(row: Invoice) {
  try {
    ...
    invoiceDetail.value = data as Invoice
