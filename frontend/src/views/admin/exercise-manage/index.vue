...
async function handleSave() {
  ...
  try {
    if (isEditing.value) {
      ...
      await fetchUpdateExerciseItem({ ...rest, id: id! } as Partial<Api.Exercise.ExerciseItem> & { id: number });
      message.success('更新成功');
    } else {
      await fetchCreateExerciseItem(form.value as Partial<Api.Exercise.ExerciseItem>);
