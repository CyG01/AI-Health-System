...
type RankingItem = { userId: number; nickname: string; avatar: string; calories: number };

type Comment = Api.Community.Comment;
...
const postDropdownOptions = [
  { label: '删除', key: 'delete', props: { style: 'color: var(--sport-accent-warm)' } }
]
...
async function handlePublish() {
  ...
  posting.value = true
  try {
    await fetchCreatePost({ ...postForm })
...
.page-header {
  ...
  align-items: center;
  margin-bottom: 20px;
  h2 { margin: 0; font-size: 22px; color: var(--sport-text-primary); }
}
...
.post-card {
  ...
  .user-meta {
    ...
    .username { font-weight: 600; font-size: 14px; color: var(--sport-text-primary); }
    .time { font-size: 12px; color: var(--sport-text-secondary); }
  }
  ...
  .post-exercise {
    ...
    .calories { color: #FFB800; font-weight: 500; }
  }
...
.ranking-item {
  ...
  &:hover { background: var(--sport-primary-subtle); }
  ...
  .rank-num {
    ...
    font-size: 14px;
    color: var(--sport-text-secondary);
    &.rank-1 { color: #FFB800; font-size: 16px; }
    &.rank-2 { color: var(--sport-text-tertiary); }
    &.rank-3 { color: var(--sport-primary); }
  }
...
.comment-item {
  ...
  .comment-user {
    ...
    gap: 8px;
    margin-bottom: 4px;
    .comment-nickname { font-weight: 600; font-size: 13px; color: var(--sport-text-primary); }
    .comment-time { font-size: 11px; color: var(--sport-text-secondary); }
  }
