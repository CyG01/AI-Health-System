...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
  ...
  /** Home route key */
  const routeHome = ref<string>(import.meta.env.VITE_ROUTE_HOME || 'dashboard');
  ...
  async function initConstantRoute() {
    ...
    // Always use static routes for this project
  ...
  async function initAuthRoute() {
    ...
    // Always use static auth route mode for this project
    initStaticAuthRoute();
  ...
  function handleUpdateRootRouteRedirect(redirectKey: string) {
    ...
    if (redirect) {
      ...
      const updatedRootRoute = { ...ROOT_ROUTE, redirect } as ElegantConstRoute;
      const [rootVueRoute] = getAuthVueRoutes([updatedRootRoute]);
